  ...
  return (
    <div className="flex justify-center h-5/6 overflow-hidden mt-20 sm:mt-0">
      ...
      >
        ...
        >
          <div className="text-white border border-blue-900 p-5 rounded-xl">
        ...
        <motion.span
          className="w-px bg-gradient-to-b from-violet-900 to-black via-blue-900 h-full hidden sm:flex"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
